...
export default function App() {
  ...
  console.log("wal",window.walletConnection);
      ...
      <main>
        ...
        <form onSubmit={async event => {
          ...
          try {
            ...
            //   const transferMoney = await window.walletConnection.account().functionCall({
            ...
            //   });
            // }
            await console.log(window.contract);

            // await window.contract.sendNear(
            //   {
            //   receiver: newGreeting,
            //   gas:BOATLOAD_OF_GAS,
            //   attachedDeposit: sum,
            // })
            
            const result = await window.walletConnection.account().functionCall({
              contractId: window.contract.contractId,
              methodName: "sendNear",
              args: { receiver: newGreeting },
              // gas:BOATLOAD_OF_GAS,
              attachedDeposit: utils.format.parseNearAmount(amount.value),
            });
          ...
          <fieldset id="fieldset">
            ...
            <div style={{ display: 'flex' }}>
              ...
              <input
                ...
                id="amount"
                onChange={e => setButtonDisabled(e.target.value === amount)}
                style={{ flex: 1 }}
              />              
              <button
